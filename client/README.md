...
# Group Allocation Project for Allocating Groups, Topics, and Supervisors for Group Discussions
...
## Instalation 
    ...
    -if error then install packages and its dependencies with command "npm install -force" or "npm i -force"

## Project (Group Allocation System)
...
## Database
    -MongoDB
    -The dump of the database (provided in svn in others section)
