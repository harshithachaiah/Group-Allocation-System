...
const SignUpPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (userType === "Supervisor") {
            e.preventDefault();
            if (!email.includes(superviserEmail)) {
                alert("Email should include leicester.ac.uk")
            }
            else {



                console.log(firstName, surName, email, password, department);
        ...
        if (userType === "Student") {
            ...
            if (!email.includes(studentEmail)) {
                alert("Email should include student.le.ac.uk")
            }

            else {
                console.log(firstName, surName, email, password, degreeType, department);
